...
export default function KuisM1K10() {
    ...
    let [question, setQuestion] = useState(dataM1K10[index]);
    ...
    const next = () => {
        if (lock === true) {
            if (index === dataM1K10.length - 1) {
                setResult(true);
                return 0;
            }
            setIndex(prev => prev + 1);
            setQuestion(dataM1K10[index + 1]); // Update this line
            setLock(false);
    ...
    const data = {
        quizname: "Basic English in Introduction",
        score: score * 10,
        percobaan: 0,
            ...
            <div className="w-full flex items-center justify-center">
                <div className=" bg-white rounded-xl py-10 px-5 mx-10 justify-center lg:w-1/2 md:w-1/3 drop-shadow-2xl shadow-2xl">
                    ...
                    <div className=" text-center mb-20 mx-auto"><h3 className="font-medium text-lg mb-2">Kuis Kelas 10</h3>
                        <h1 className="font-bold text-3xl">Basic English in Introduction</h1>
                    </div>
                    {result ? <></> : <>
                    ...
                    {result ? (
                        <div className="text-center">
                            ...
                            <h1 className="mb-5 text-lg font-semibold">
                                You Score {score} out of {dataM1K10.length} questions
                            </h1>

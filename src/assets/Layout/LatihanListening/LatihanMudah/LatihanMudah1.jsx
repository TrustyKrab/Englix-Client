...
import PilGanLatMudah from "./PilGanLatMudah";

function LatihanMudah1() {
    ...
    useEffect(() => {
        ...
        // import musik
        wavesurfer.load('/LatihanMudah1.mp3');
    ...
    return (
        <>
            <div className="font-main bg-blue-100">
                <NavbarHome />

...
export default function PilGanLatMudah() {
    ...
    let [question, setQuestion] = useState(dataLatihanMudah[index]);
    ...
    const next = () => {
        if (lock === true) {
            ...
            setQuestion(dataLatihanMudah[index + 1]); // Update this line
            setLock(false);
    ...
    const data = {
        quizname: "Latihan Listening Mudah",
        score: score * 20,
        percobaan: 0,
                        ...
                        {result ? (
                            <div className="text-center">
                                ...
                                <h1 className="mb-5 text-lg font-semibold">
                                    You Score {score} out of {dataLatihanMudah.length} questions
                                </h1>

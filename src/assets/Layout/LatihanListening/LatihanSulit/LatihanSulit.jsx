...
import PilGanLatSulit from "./PilGanLatSulit";
import { Link } from "react-router-dom";

function LatihanSulit() {
    ...
    useEffect(() => {
        ...
        // import musik
        wavesurfer.load('/LatihanSulit1.mp3');
    ...
    return (
        <>
            <div className="font-main bg-blue-100 h-[98vh]">
                <NavbarHome />
                <div className="mx-36 py-24 mt-3 ">
                    ...
                    <Link to="/PilGanLatSulit">
                        <div className="flex justify-center items-center">
                            <button className="text-center text-white text-lg font-medium bg-blue-500 hover:bg-pink-500 py-1 px-5 rounded-lg">Start</button>
                        </div>
                    </Link>
                </div>

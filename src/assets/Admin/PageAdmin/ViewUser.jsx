        ...
        <>
            <div className=" p-4 w-full flex flex-wrap justify-center items-center lg:p-7">
                ...
                <form className="w-full lg:w-4/5  p-4 bg-white rounded shadow-lg">
                    ...
                    <div className="mb-2">
                        <label htmlFor="notlp" className="text-base font-bold w-full block sm:text-xl">No. Telpon</label>
                        <input value={`${notlp}`} type="number" name="password" id="password" className="py-2 px-3 text-white w-full bg-slate-400 rounded placeholder:text-slate-300 text-xs sm:text-base" placeholder="Link ..." disabled />
                    </div>

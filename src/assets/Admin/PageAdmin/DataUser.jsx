...
const DataUser = () => {
    ...
    const deleteUser = async (id) => {
        try {
            await axios.delete(`http://localhost:3000/user/${id}/deleteUser`)
    ...
    return(
        <>
            <div className="w-ful py-36 px-1 sm:px-3 md:px-5  lg:px-11 lg:py-10 h-screen overflow-auto">
                <h1 className="text-purple-600 font-bold text-2xl text-center mb-4 md:text-6xl md:mb-8 lg:mb-14">USERS DATA</h1>

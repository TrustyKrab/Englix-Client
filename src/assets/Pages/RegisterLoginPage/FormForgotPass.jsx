            ...
            <div className="w-full sm:w-4/5 md:w-1/2 lg:w-2/5 border-2 rounded-2xl px-6 bg-white my-20 sm:my-30 md:my-40 py-5">
                ...
                <form onSubmit={handleSubmit} className="mb-3">
                    ...
                    <div className="justify-center flex mb-5">
                        <button type="submit" className="bg-pink-500 text-white text-base rounded-lg py-2 px-3 hover:bg-pink-600 hover:scale-105 transition duration-200">KIRIM LINK</button>
                    </div>
                </form>

...
export default function SidebarK10() {
    ...
    return (
        <div className="relative flex flex-col md:flex-row bg-blue-100 ">
            ...
            {/* Konten */}
            <div
                className={`flex-1 h-[100vh] pb-10 relative overflow-y-auto transition-transform duration-300 ${isSidebarOpen ? 'transform translate-x-full' : 'transform translate-x-0'}`}
            >
                <button
